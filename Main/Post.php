...
<div class="post-card" data-pid="<?php echo $PID; ?>">
  <div class="post-header">
    <?php if (!empty($postProfileIcon) && $IsAnonymouse == 0) { ?>
      <img src="data:image/jpeg;base64,<?php echo base64_encode($postProfileIcon); ?>" alt="Post Image" class="profile-icon">
    <?php } else { ?>
      <img src="../IMG/defaultProfile.png" alt="Profile" class="profile-icon">
    <?php } ?>
    <div class="user-info">
  ...
  <div class="post-footer">
    <button class="footer-btn upvote-button" onclick="updateVotes(1, <?php echo $PID ?>)">
      <img src="../IMG/like.jpg" alt="Like" class="btn-icon">
    ...
    <button class="footer-btn downvote-button" onclick="updateVotes(0, <?php echo $PID ?>)">
      <img src="../IMG/dislike.jpg" alt="Dislike" class="btn-icon">
